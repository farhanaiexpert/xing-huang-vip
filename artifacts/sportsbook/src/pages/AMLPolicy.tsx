...
const SECTIONS = [
  {
    ...
    body: 'CupBett is committed to preventing money laundering and terrorist financing. We operate in full compliance with the EU Anti-Money Laundering Directive (AMLD) and the requirements of the Malta Gaming Authority.',
  },
  {
  ...
  },
  {
    ...
    body: 'CupBett has a designated Money Laundering Reporting Officer (MLRO). Suspicious transactions are reported to the Financial Intelligence Analysis Unit (FIAU) in Malta as required by law.',
  },
  {
