...
// Pull the first bookmaker h2h market from an event
...
function LiveOddsButton({ event, outcome, marketKey, score }: LiveOddsButtonProps) {
  ...
  // Map outcome name to team display label
  const label =
...
function LiveMatchCard({ event }: LiveMatchCardProps) {
      ...
      <div className="px-4 py-3">
        <div className="flex items-center justify-between mb-3">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px] text-[#64748B] mt-0.5">vs</p>
...
export function LivePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F14] pb-20">
      {/* Header */}
      <div className="sticky top-14 z-30 bg-[#0B0F14]/95 backdrop-blur-xl border-b border-[#253241]/60 px-4 md:px-6 py-3">
