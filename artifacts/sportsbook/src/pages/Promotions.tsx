      ...
      <main className="max-w-5xl mx-auto px-3 sm:px-6 py-6 sm:py-10">
            ...
            <div className="relative px-4 sm:px-8 py-6 sm:py-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
              <div>
                ...
                <p className="text-[#94A3B8]/70 text-sm mt-1.5 max-w-sm">
                  New to <span translate="no">Xing Huang</span>? Your first deposit is matched 100% — up to <span className="text-[#00DFA9] font-bold">500 USDT</span> in bonus funds.
                </p>
        ...
        <div className="mt-10 flex items-start gap-2 p-4 rounded-xl bg-[#121821] border border-[#253241]">
          ...
          <p className="text-[10px] text-[#94A3B8]/35 leading-relaxed">
            All promotions are subject to Xing Huang's general{' '}
