...
const SECTIONS = [
  {
    ...
    content: [
      ...
      { heading: 'Decimal odds (default)', text: 'Xing Huang shows decimal odds by default. Your total return (stake + profit) = Stake × Odds. So 10 USDT at 3.50 returns 35 USDT total, a profit of 25 USDT.' },
  ...
  },
  {
    ...
    content: [
      { heading: 'Why a wallet?', text: 'Xing Huang is a decentralised sportsbook. Your wallet is your identity and your funds. There are no accounts or passwords — just your wallet address.' },
      ...
      <div className="flex-1 max-w-2xl w-full mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-xs text-[#94A3B8] mt-0.5">How Xing Huang works</p>
          </div>
        </div>
