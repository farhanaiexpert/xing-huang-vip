...
import { X, QrCode, Zap, CreditCard, Wallet, ArrowRight, Lock, Shield, Clock, CheckCircle2, CircleDollarSign, Sparkles } from 'lucide-react';
...
export function ConnectWalletModal({ open, onOpenChange, isOpen, onClose }: ConnectWalletModalProps) {
  ...
  function handleDeposit(method: 'nowpayments' | 'manual' = 'nowpayments') {
    close();
    if (user) {
      navigate('/account/wallet');
      // Hint WalletPage to open on the correct tab via sessionStorage
    ...
    <>
      {isVisible && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
          ...
          {/* Modal */}
          <div
            className="relative w-full max-w-[440px] rounded-2xl overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.9)]"
            style={{ background: '#0D1117', border: '1px solid rgba(255,255,255,0.07)' }}
          >
            {/* Top accent bar */}
            <div className="absolute top-0 left-0 right-0 h-[2px]"
              style={{ background: 'linear-gradient(90deg, #00DFA9, #38BDF8, #A78BFA)' }} />
            ...
            <div className="px-4 py-4 space-y-3">
              ...
              {/* ── NOWPayments — AUTO (primary / recommended) ── */}
              <button
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-[#94A3B8] leading-relaxed">
                      Send USDT TRC-20 to our wallet, paste your TxID — credited in 5–30 min.
                    </p>
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      <span className="w-px h-3 bg-white/[0.1]" />
                      <span className="text-[11px] text-[#64748B]">TRC-20 only</span>
                    </div>
                  </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-[11px] font-bold text-[#94A3B8] leading-tight">{m.name}</p>
                          <p className="text-[9px] text-[#64748B]">{m.tag}</p>
                        </div>
