...
export const zh: Record<string, string> = {
  ...
  "Pick a selection to start":                         "选择开始投注",
  ...
  // ── Home / Main content ───────────────────────────────────────────────────
  "Live Offer":                "限时优惠",
  "Deposit USDT & Start Gambling": "存入 USDT 开始博彩",
  "Zero fees":                 "零手续费",
  "Instant settlement":        "即时结算",
  "Bonus up to":               "最高奖金",
  "100% first deposit match":  "首存 100% 匹配奖金",
  "Deposit Now →":             "立即存款 →",
  ...
  "Odds may be suspended during key moments": "关键时刻赔率可能暂停",
  "played":                  "已进行",
  "volume":                  "交易量",
  "rising":                  "上涨",
  "falling":                 "下跌",
  ...
  "Match Result · Win probability":  "比赛结果 · 胜率",
  "HOT":                             "热门",
  "Away":                            "客队",
  "Home Team":                       "主队",
  ...
  "Weekly":                "每周",
  "Loyalty":               "忠诚度",
  "100% Welcome Bonus":    "100% 欢迎奖金",
  "Up to 500 USDT on your first deposit": "首存最高 500 USDT 奖金",
  "100% Match Bonus":      "100% 匹配奖金",
  "Welcome offer":         "欢迎优惠",
  "Free Bet Friday":       "周五免费投注",
  "Refer a Friend":        "推荐好友",
  "In-Play Cashback":      "现场返现",
  "Bet Now":               "立即投注",
  "Claim Bonus":           "领取奖金",
  "Learn More":            "了解更多",
  "Copy Your Link":        "复制链接",
  "Claim 500 USDT Bonus":  "领取 500 USDT 奖金",
  "Most Popular":          "最受欢迎",
  "New Players":           "新玩家",
  "Always On":             "长期有效",
  "Every Friday":          "每周五",
  ...
  "Points multiplier":     "积分倍数",
  "Join & Start Earning":  "加入并开始赚取",
  "Resets Monday":         "每周一重置",
  ...
  "Selecting Odds":           "选择赔率",
  "Using the Bet Slip":       "使用投注单",
  "Accumulator Bets":         "串关投注",
  ...
  "Per match on event page":  "每场比赛赛事页面",

  // ── WinSpin page ──────────────────────────────────────────────────────────
  "Spin & Win":               "旋转赢奖",
  "Daily Free Spin":          "每日免费旋转",
  "Provably Fair":            "可验证公平",
  ...
  "Wallet required to win":   "赢奖需连接钱包",
  "How it works":             "如何运作",
  "Popular":                  "热门",
  "Confirm Pick":             "确认选择",
  "picks":                    "票",
  ...
  "Enter Amount":         "输入金额",
  "Withdraw Address":     "提款地址",
  "Network":              "网络",
  "Min deposit":          "最低存款",
  "Processing time":      "处理时间",
  "Scan to deposit":      "扫码存款",
  "Copy address":         "复制地址",
  ...
  "Current":              "当前",
  "Loyalty points":       "忠诚积分",
  "Access to all markets": "访问所有市场",
  "Standard withdrawal speed": "标准提款速度",
  "Priority support":     "优先客服",
  "Faster withdrawals":   "更快提款",
  "Diamond":              "钻石",
