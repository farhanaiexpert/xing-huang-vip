...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {/* Desktop sidebar */}
      <aside className="hidden md:flex w-56 flex-col bg-[#0A0E13] border-r border-border shrink-0 fixed top-0 bottom-0 left-0 z-20">
        <div className="px-5 py-5 flex items-center gap-2 border-b border-border">
          ...
          <span className="font-bold text-foreground text-sm">CupBett</span>
          <span className="text-[10px] font-semibold text-primary bg-primary/10 px-1.5 py-0.5 rounded border border-primary/20 ml-auto">Admin</span>
        </div>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-30">
        <header className="flex items-center justify-between h-13 px-4 bg-[#0A0E13] border-b border-border">
          ...
          <button
            ...
            className="p-1.5 rounded-lg hover:bg-muted/40 text-foreground transition-colors"
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          />
          <aside className="relative z-50 w-64 h-full flex flex-col bg-[#0A0E13] border-r border-border shadow-2xl">
            <div className="px-5 py-5 flex items-center gap-2 border-b border-border">
              <div className="w-7 h-7 rounded bg-primary flex items-center justify-center shrink-0">
                <svg className="w-3.5 h-3.5 text-primary-foreground" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 1a4.5 4.5 0 00-4.5 4.5V9H5a2 2 0 00-2 2v6a2 2 0 002 2h10a2 2 0 002-2v-6a2 2 0 00-2-2h-.5V5.5A4.5 4.5 0 0010 1zm3 8V5.5a3 3 0 10-6 0V9h6z" clipRule="evenodd" />
              ...
              <span className="font-bold text-foreground text-sm">CupBett Admin</span>
              <button
                onClick={() => setMobileOpen(false)}
      ...
      <div className="flex-1 flex flex-col md:ml-56 min-w-0">
        <main className="flex-1 p-6 pt-[calc(1.5rem+52px)] md:pt-6">
          {children}
        </main>
      </div>
    </div>
